...
\begin{itemize}
  ...
  \item \textbf{Statistiche repository}: 76 commit complessivi e 3 contributor rilevati nella history Git
  \item \textbf{Contributors}: Alessandro Minopoli (55 commit), Simoalvin (23 commit), PorfirioTramontana (2 commit)
  \item \textbf{Frequenza dei commit}: attivit\`a distribuita tra ottobre 2025 e marzo 2026, con picco finale nel mese di marzo 2026 (45 commit)
\end{itemize}
