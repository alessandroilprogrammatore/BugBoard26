...
\vspace{0.25cm}
{\normalsize\color{bbMuted} Corso di Ingegneria del Software --- Canale 2\par}
\vspace{2.2cm}
{\color{bbAccent}\rule{0.88\textwidth}{1.3pt}\par}
\vspace{0.8cm}
...
\vspace{0.25cm}
{\normalsize\color{bbMuted} Sistema distribuito per issue tracking, collaborazione e reporting\par}
\vspace{0.8cm}
{\color{bbAccent}\rule{0.88\textwidth}{1.3pt}\par}
\vspace{1.4cm}

{\small
\colorbox{bbLight}{\parbox{0.82\textwidth}{\centering
