...
\begin{figure}[H]
\centering
\includegraphics[width=\textwidth]{component_diagram_detailed.png}
\caption{Component Diagram dettagliato, allineato alla struttura effettiva del repository}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[width=\textwidth]{deployment_diagram_detailed.png}
\caption{Deployment Diagram dettagliato con ambiente Docker, fallback locale e volumi persistenti}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[width=0.8\textwidth]{interface_controller_security_layer.png}
\caption{Vista dettagliata del layer Interface / Controller / Security}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[width=0.8\textwidth]{service_application_layer.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=\textwidth]{persistence_domain_detailed.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=\textwidth]{sequence_assign_bug.png}
