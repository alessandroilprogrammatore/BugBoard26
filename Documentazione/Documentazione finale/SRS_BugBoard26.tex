...
La prototipazione visuale di BugBoard26 \`e stata realizzata in \textbf{Figma} attraverso mock-up ad alta fedelt\`a, successivamente usati come riferimento per l'implementazione React del prototipo funzionante. Le schermate riportate in questa sezione corrispondono quindi a tavole progettuali definite in fase di design e poi validate rispetto ai flussi effettivamente implementati.
